...
if __name__ == '__main__':
    ...
    try:
        ...
        ###########################################################################
        # agc03_sensor_omron_cmd_pub = rospy.Publisher("agc03_sensor_omron_cmd", String, queue_size=1)
        ###########################################################################
        ...
        while not rospy.is_shutdown():
            ...
            # agc03_sensor_omron_cmd_pub.publish("on11")
            # agc03_sensor_omron_cmd_pub.publish("on11")
            # agc03_load_in_10(10)
            # rospy.sleep(5)
            # agc03_sensor_omron_cmd_pub.publish("off1")
            # agc03_sensor_omron_cmd_pub.publish("off1")
            #agc03_load_in_10(10)
            #rospy.sleep(15)
            ...
            #agc03_LED_cmd_pub.publish("RUN1")
            #rospy.sleep(0.5)
            #ARFollower(10, 0.69, 0.1, 1)   # ARFollower(10, 1.10, 0.1, 10)
         ##### ARFollower(10, 0.60, 0.1, 1)   # ARFollower(10, 1.10, 0.1, 10)

            #GoToPose(1.80,0.54,180.0)    #GoToPose Roller AR 11
            GoToPose(2.0,0.54,182.0)    #GoToPose Roller AR 11
            #agc03_LED_cmd_pub.publish("RUN2")
            #agc03_LED_cmd_pub.publish("RUN2")
            ARFollower(11, 0.56, 0.007, 10.0) ### ARFollower(11, 0.51, 0.006, 16)
            ...
            agc03_buzzer_cmd_pub.publish("ch1")
            #rospy.sleep(0.5)
            #ARFollower(11, 0.69, 0.1, 1)
      #####      ARFollower(11, 0.60, 0.1, 1)
            ...
            #GoToPose(0.8,-0.001,0.0)   #GoToPose Roller AR 10  ##GoToPose(-1.0,1.64,-180)
            #GoToPose(0.6,-0.001,0.0)   #GoToPose Roller AR 10  ##GoToPose(-1.0,1.64,-180)
            GoToPose(0.55,-0.001,0.0)   #GoToPose Roller AR 10  ##GoToPose(-1.0,1.64,-180)
            #agc03_LED_cmd_pub.publish("RUN2")

            agc03_LED_cmd_pub.publish("RUN2")
            ARFollower(10, 0.56, 0.007, 10.0)
