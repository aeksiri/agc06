...
class ARFollower():
    def __init__(self):
        ...
        self.max_linear_speed = rospy.get_param("~max_linear_speed", 0.13) #0.073 / 0.15
        ...
        self.max_angular_speed = rospy.get_param("~max_angular_speed", 0.13)  #0.095/ 0.1
        
        # The minimum rotation speed in radians per second
        self.min_angular_speed = rospy.get_param("~min_angular_speed", 0.12) #0.095/ 0.1 /0.13
        ...
        self.y_threshold = rospy.get_param("~y_threshold", 0.01)    #0.05
        ...
        self.y_scale = rospy.get_param("~y_scale", 0.1) # 1.0
