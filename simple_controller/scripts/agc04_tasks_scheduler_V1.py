...
#         ######################### Publish to AGC02 #######################################################
#         self.agc04_cmd_pub = rospy.Publisher('agc04_status', String, queue_size=10)
#         ##################################################################################################

#         #ros.loginfo("status = %s" % sending_agc04_status)
...
#             self.agc04_cmd_pub.publish(sending_agc04_status)
#             self.r.sleep()
#             self.agc04_cmd_pub.publish(sending_agc04_status)
#             self.r.sleep()
#             self.agc04_cmd_pub.publish(sending_agc04_status)
...
def talker(message):
    '''test Publisher'''
    pub = rospy.Publisher('agc04_cmd', String, queue_size=10)
