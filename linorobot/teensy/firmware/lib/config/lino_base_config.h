...
#define MAX_RPM 181               // motor's maximum RPM
#define COUNTS_PER_REV 8000       // wheel encoder's no of ticks per rev
#define WHEEL_DIAMETER 0.143  //0.13648176796       // wheel's diameter in meters
#define PWM_BITS 8                // PWM Resolution of the microcontroller
#define LR_WHEELS_DISTANCE 0.38966  // distance between left and right wheels
#define FR_WHEELS_DISTANCE 0.375   // distance between front and rear wheels. Ignore this if you're on 2WD/ACKERMANN
...
//MOTOR PINS
  ...
  #define MOTOR2_IN_A 25 //5
  #define MOTOR2_IN_B 32 //6
  ...
  #define MOTOR4_IN_A 25 //4
  #define MOTOR4_IN_B 32 //3
