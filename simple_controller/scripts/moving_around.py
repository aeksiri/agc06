...
if __name__ == '__main__':
    ...
    try:
        rospy.init_node('cart_tracking', anonymous=False)
        
        while not rospy.is_shutdown():

          GoToPose(4.0,-1.0,90.0)    #GoToPose Roller AR 11
          GoToPose(2.0,-2.0,-90.0)
          GoToPose(2.0,-7.0,0.0)
          GoToPose(4.0,-5.0,90.0)
