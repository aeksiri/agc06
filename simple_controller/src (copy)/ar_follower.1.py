...
class ARFollower():
    def __init__(self):
        ...
        self.max_angular_speed = rospy.get_param("~max_angular_speed", 0.2)  #0.095/ 0.1
        
        # The minimum rotation speed in radians per second
        self.min_angular_speed = rospy.get_param("~min_angular_speed", 0.13) #0.095/ 0.1
        ...
        self.y_threshold = rospy.get_param("~y_threshold", 0.05)    #0.05
