...
class TagsCOG():
    def __init__(self):
        ...
        self.tag_pub = rospy.Publisher("roller_pose", PoseStamped, queue_size=5)

        rospy.Subscriber("ar_pose_marker", AlvarMarkers, self.get_tags)
        
        rospy.loginfo("Publishing combined tag COG on topic /roller_pose...")
